...
for k, factivacion in enumerate(factivaciones):
    ...
    if graficar:
        ...
        plt.savefig('informe/graficos/factivaciones_'+factivacion+'.png')
...
plt.ylabel('Error/Funcion Costo')
plt.legend(loc=1)
plt.savefig('informe/graficos/factivaciones_promedios_entrenamiento.png')
plt.clf()
...
plt.ylabel('Error/Funcion Costo')
plt.legend(loc=1)
plt.savefig('informe/graficos/factivaciones_promedios_validacion.png')
plt.clf()
